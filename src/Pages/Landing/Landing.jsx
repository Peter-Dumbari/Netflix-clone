    ...
    <div className="landing-page">
      ...
      <section className="frequently-ask-quest">
        <div className="inner-section">
          ...
          <CollapsibleItem title="What is Netflix?">
            ...
            <br />
            <br />
            -all for one low monthly price. There is always something new to
            discover and new TV shows and movies are added every week!
          </CollapsibleItem>
          <CollapsibleItem title="How does Netflix cost?">
            <div>
              Watch Netflix on your smartphone, tablet, Smart TV, laptop, or
              streaming device, all for one fixed monthly fee. Plans range from
              ₦4,400 to ₦1,200 a month. No extra costs, no contracts.
            </div>
          </CollapsibleItem>
          <CollapsibleItem title="Where can I watch?">
            <div>
          ...
          <CollapsibleItem title="How do I cancel?">
            <div>
          ...
          <CollapsibleItem title="What can I watch on Netflix?">
            <div>
          ...
          <CollapsibleItem title="Is Netflix good for kids?">
            <div>
